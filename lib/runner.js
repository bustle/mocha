...
var TEST_IX = 0
var EVERY_NTH = +process.env.EVERY_NTH
var N_IX = +process.env.N_IX
...
Runner.prototype.runTests = function(suite, fn) {
  ...
  function next(err, errSuite) {
    ...
    // A bit of a hack to only execute every nth test
    if (EVERY_NTH > 0 && N_IX >= 0 && TEST_IX++ % EVERY_NTH !== N_IX) {
      return next();
    }
